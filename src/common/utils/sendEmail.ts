...
export const sendEmail = async (email: string) => {
  ...
  const transporter = nodemailer.createTransport({
    ...
    auth: {
      user: 'tengu.noreply@gmail.com', // generated ethereal user
      pass: 'tengu123456789', // generated ethereal password
    },
  });

  const info = await transporter.sendMail({
    from: '"Fred Foo 👻" <tengu.noreply@gmail.com>',
    to: email,
    subject: 'Hello ✔',
    text: 'Hello world?',
    // html: `<b>Hello world?</b> <a href="http://localhost:3000/">confirm Email</a>`,
    html: `<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" xmlns:v="urn:schemas-microsoft-com:vml"><head>
